# -*- coding: utf-8 -*-
"""
Created on Thu Dec  9 16:00:56 2021
...
pvars = r.addVars(plants, years, vtype=GRB.BINARY, lb = 0, ub = 1,  name = "pvar") # whether the plant i’s production line is open at the beginning of year t. 1: open, 0: close (binary) 
e1vars = r.addVars(plants, years, vtype=GRB.BINARY, lb = 0, ub = 1,  name = "e1")
e2vars = r.addVars(plants, years, vtype=GRB.BINARY, lb = 0, ub = 1,  name = "e2")
fvars = r.addVars(plants, years, vtype=GRB.BINARY, lb = 0, ub = 1,  name = "fvar") # whether the production line in the plant i is going to be shut down at the end of year t or not. 1: shut down, 0: close (binary) 
gvars = r.addVars(plants, years, vtype=GRB.BINARY, lb = 0, ub = 1,  name = "gvar") # whether the production line in the plant i in year t is the initial construction year. 1: initial, 0: not initial (binary)
hvars = r.addVars(plants, years, vtype=GRB.BINARY, lb = 0, ub = 1,  name = "hvar") # whether the production line in the plant i was never opened before year t or not. 1: not opened before, 0: opened before (binary) 
